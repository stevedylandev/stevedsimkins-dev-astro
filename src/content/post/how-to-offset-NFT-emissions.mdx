...
![Ethereum energy stats](https://cdn-images-1.medium.com/max/2400/1*xQEP67xsPsQ4vU7wjKLFBw.png)
...
```javascript
<iframe src="[https://www.aerial.is/nft/embed?address=0x3e88721fa41d5e102d54b4a04e550222efdd234d](https://www.aerial.is/nft/embed?address=0x3e88721fa41d5e102d54b4a04e550222efdd234d)">
```
![screenshot of aerial widget](https://cdn-images-1.medium.com/max/2000/1*IPAefM4T_NiRygdri_DzhA.png)
...
![console log](https://cdn-images-1.medium.com/max/2000/1*UrdopTgDhErJObLI3V8DwQ.png)
